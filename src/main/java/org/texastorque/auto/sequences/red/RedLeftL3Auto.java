...
public class RedLeftL3Auto extends TorqueSequence implements Subsystems {
    
    public RedLeftL3Auto() {
        // Drive left to close left
        addBlock(new TorqueFollowPath("RLL3_1", drivebase).withMarkers(
            new Marker(() -> {
        ...
        addBlock(new TorqueFollowPath("RLL3_2", drivebase).withMarkers(
            new Marker(() -> {
        ...
        addBlock(new TorqueFollowPath("RLL3_3", drivebase).withMarkers(
            new Marker(() -> {
