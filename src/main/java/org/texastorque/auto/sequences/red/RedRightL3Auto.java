...
public class RedRightL3Auto extends TorqueSequence implements Subsystems {
    
    public RedRightL3Auto() {
        // Drive right to close right
        addBlock(new TorqueFollowPath("RRL3_1", drivebase).withMarkers(
            new Marker(() -> {
        ...
        addBlock(new TorqueFollowPath("RRL3_2", drivebase).withMarkers(
            new Marker(() -> {
        ...
        addBlock(new TorqueFollowPath("RRL3_3", drivebase).withMarkers(
            new Marker(() -> {
