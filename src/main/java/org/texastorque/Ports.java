...
public final class Ports {
	public static final SwervePorts FR_MOD = new SwervePorts(1, 4, 9);
    public static final SwervePorts BR_MOD = new SwervePorts(3, 6, 12);
    public static final SwervePorts BL_MOD = new SwervePorts(5, 8, 10);
    public static final SwervePorts FL_MOD = new SwervePorts(7, 2, 11);
