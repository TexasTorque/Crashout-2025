...
public final class Claw extends TorqueStatorSubsystem<Claw.State> implements Subsystems {
    ...
    public static enum AlgaeState implements TorqueState {
        INTAKE(-10), SHOOT_SLOW(2), SHOOT(6), SHOOT_SEMI_FAST(11), SHOOT_FAST(12), OFF(0);
    ...
    public final void update(final TorqueMode mode) {
        ...
        // Coral rollers logic
        if (coralState == CoralState.SHOOT || coralState == CoralState.SHOOT_FAST) 
            coralSpike.reset();
        ...
        if (hasCoral() && (coralState != CoralState.SHOOT || coralState != CoralState.SHOOT_FAST)) {
            coralState = CoralState.OFF;
